...
HOLD = {
 ...
 "p2-synopsis": ("self", "3 drafts written — pick one"), "p2-hero-still": ("self", "pick from the 43 stills"),
 ...
 "p4-photo-behind": ("self", "pick from the 43 stills"), "p5-bio-director": ("have", "draft — 2 brackets for Jordan"),
 ...
 "p7-cast-bios": ("self", "end credits + IMDb"), "p7-stills-in-character": ("self", "pick from the 43 stills"),
 "p8-bts-photos": ("blk", "Jordan drives — or crew phones"), "p9-key-credits": ("self", "sound + EPs from end credits"),
 "p9-full-cast": ("self", "end credits"), "p9-still-behind": ("self", "pick from the 43 stills"),
 ...
 "a-stills": ("have", "43 in press/assets/STILLS — pick 12"), "a-trailer": ("blk", "Yeo"),

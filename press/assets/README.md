...
| `LAURELS/ABFF-2026-official-selection-{black,white}.png`, `MVAAFF-2026-…`, `SCAD-2026-…` | The three official-selection laurels, 1735 × 1152 PNG, transparent, one black-ink and one white-ink version each, bytes unchanged from the Drive (its names: `OFFICIAL SELECTION - <festival> - 2026.png` black, the same with `(1)` white). The Drive also holds `LAURELS/AFI Fest/FESTConservatoryShowcase_Laurels*.png`, a generic 2022 AFI FEST laurel with no KOM selection on record, not copied | Drive `05 MARKETING/00 PRESS/LAURELS`, arrived 23 Sep 2026 | 2026-09-23 |
...
Still to arrive: the trailer (`press/epk.json`, A.2). The laurels came 2026-09-23 (A.3). The five headshots are the complete set: the director's was on the Drive under the session's own name, `KOM Headshots-1.jpg`, and joined the repo 2026-09-11. Chosen 2026-09-23 and recorded in `press/epk.json`: the hero still, the photo behind the statement, the stills in character (7.2), the stills behind the credits, the twelve press stills and the ten page-8 photographs (A.1 and 8.1). The send-ready copies are on the Drive in `05 MARKETING/00 PRESS/EPK-2026-09-23/`.
